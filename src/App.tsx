              ...
              {step === 'article' && (
                <div className="space-y-8">
                  ...
                  <div className="w-full mb-8 relative rounded-3xl overflow-hidden border border-slate-800 shadow-2xl">
                    <img
                      src="/nano_banana_theme.png"
                      alt="Nano Banana AI Theme"
                      className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700"
                    />
                    <div className="absolute bottom-4 left-4 right-4 text-center">
                      <p className="text-xs text-white/70 bg-black/50 backdrop-blur-md py-1 px-3 rounded-full inline-block">Header Image generated by Nano Banana</p>
                    </div>
                  </div>
